...
class SetupApp():
    def __init__(self, wait = .033, cam = 'atik'):
        ...
        if self.camLive == 2:
            ...
            scanapp = ScanApp(camera=self.camera,exposure=self.exposure,ds=self.ds,hwp=self.hwp,dsPositions=dsPositions,fluences=fluences,hwpWait=hwpWait,dsWait=dsWait,imalus=self.imalus,batchSize=batchSize,\
...
class ScanApp():
    def __init__(self, camera, exposure, ds, hwp, dsPositions, fluences, hwpWait, dsWait, imalus, batchSize, translationCorrectionQ, scanMedianFilterQ, smartScanQ, scanDir, rm, scansweepselection, wait = .033):
        self.camera=camera
        ...
        # Grab an image here, this function updates the self.camImage global variable
        self.collectImage()
